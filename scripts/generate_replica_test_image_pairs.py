"""
Generate Replica image pairs (in the same way as synsin) for testing.
...
opt.test_data_path = (
    "data/scene_episodes/mp3d_test/dataset_one_ep_per_scene.json.gz"
)

opt.scenes_dir = "/home/zihang/developer/data/matterport/"
...
dataset_output_path = '/home/zihang/developer/data/mp3d_test/'
os.makedirs(dataset_output_path, exist_ok=True)

images_before_reset = 200
N_iter = images_before_reset * 18
